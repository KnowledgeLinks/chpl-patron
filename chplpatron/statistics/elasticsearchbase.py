...
from chplpatron.utilities import IsFirst, get2, Dot, first
from .esutilities import get_es_action_item
...
class EsBase():
    ...
    def _find_ids(self,
        ...
        for item in data_list:
            # the Dot class will retrieve and set dictionary values via dot
            # notation
