...
class EsSierraBulkLoader(object):
    ...
    def _index_item(self, patron_id, num, batch_num):
        """
        Queries sierra and get a patron record

        :param patron_id: the patron identifier
        :param num:
        :param batch_num:
        :return:
        """

        data = sierra.lookup_by_id(patron_id)
